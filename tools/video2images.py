...
def main(args):
    ...
    for vid_name in vid_list[30:60]:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--csv_path", type=str, default="../PianoYT/pianoyt.csv")
    parser.add_argument("--video_path", type=str, default="../videos/train")
    parser.add_argument("--save_path", type=str, default="../ytdataset/images/training/")
